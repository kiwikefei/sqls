select i.name ,count(actived.user_id) from instances i
...
where u.created_at between '2017-06-01 00:00:00' and '2017-06-30 00:00:00') as actived on actived.user_id = u.id
group by i.id
